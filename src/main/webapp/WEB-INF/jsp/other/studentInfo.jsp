							...
							<div class="panel-footer white-bg">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<ul class="profile-info">
										...
										<li><i class="fa-bitbucket"></i>职务：${user.role }</li>
										...
										<li><i class="fa-bitbucket"></i>学号：${user.sno }</li>
										<li><i class="fa-bitbucket"></i>寝室楼：${user.dormno }</li>
										<li><i class="fa-bitbucket"></i>寝室号：${user.dormInfo }</li>
										<li><i class="fa-bitbucket"></i>政治面貌：${user.politicalStatus }</li>
										<li><i class="fa-bitbucket"></i>银行卡号：${user.bankCard }</li>
										<li><i class="fa-bitbucket"></i>贫困：${user.haveLoan }</li>
										<li><i class="fa-bitbucket"></i>贷款：${user.havePovertyCertificate }</li>
										<li><i class="fa-bitbucket"></i>父亲：${user.fatherName }</li>
										<li><i class="fa-bitbucket"></i>父亲电话：${user.fatherPhone }</li>
										<li><i class="fa-bitbucket"></i>母亲：${user.motherName }</li>
										<li><i class="fa-bitbucket"></i>母亲电话：${user.motherPhone }</li>
									</ul>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<ul class="profile-info">
